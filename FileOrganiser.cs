...
{
    public class FileOrganiserForm : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            titleLabel.Text = "File Organiser";
            ...
            subtitleLabel.Text = "Organise files based on a CSV with 'name' and 'output' columns";
            ...
            // Organise Button
            Button OrganiseBtn = new Button();
            OrganiseBtn.Text = "Organise Files";
            OrganiseBtn.Location = new Point(250, 280);
            OrganiseBtn.Size = new Size(120, 35);
            OrganiseBtn.BackColor = Color.FromArgb(76, 175, 80);
            OrganiseBtn.ForeColor = Color.White;
            OrganiseBtn.FlatStyle = FlatStyle.Flat;
            OrganiseBtn.Font = new Font("Arial", 10, FontStyle.Bold);
            OrganiseBtn.Click += OrganiseFiles;
            this.Controls.Add(OrganiseBtn);
        ...
        private void BrowseSource(object sender, EventArgs e)
        {
            ...
            {
                dialog.Description = "Select Folder Containing Files to Organise";
                if (dialog.ShowDialog() == DialogResult.OK)
                {
        ...
        private void BrowseDest(object sender, EventArgs e)
        {
            using (FolderBrowserDialog dialog = new FolderBrowserDialog())
            {
                dialog.Description = "Select Root Folder for Organised Files";
                if (dialog.ShowDialog() == DialogResult.OK)
                {
        ...
        private void OrganiseFiles(object sender, EventArgs e)
        {
            // Validate inputs
            ...
            AppendLog("SUMMARY");
            AppendLog("============================================================");
            AppendLog("✓ Successfully Organised: " + successCount.ToString());
            ...
            MessageBox.Show("Successfully Organised: " + successCount.ToString() + "\nNot found: " + notFoundCount.ToString() + "\nErrors: " + errorCount.ToString(),
        ...
        static void Main()
        {
            ...
            Application.Run(new FileOrganiserForm());
        }
    }
}
